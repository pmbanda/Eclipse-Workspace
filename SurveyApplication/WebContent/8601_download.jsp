...
<h5>To register for our downloads, enter your name and email<br> address below. Then, click on the submit button. </h5>
		...
		<table class="table" border="0" cellspacing="5">
			...
			<tr>
				...
				<th><audio src="/SurveyApplication/WebContent/sound/<%=productCode%>/<%=response.encodeURL("Heat.mp3") %>" controls></audio></th>
				<!-- <a href="/WebContent/sound/<%=productCode%>/Heat.mp3">Mp3</a> -->
			</tr>
		</table>
